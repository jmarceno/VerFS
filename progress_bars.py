...
bar_format_MB = "{desc:32}{percentage:3.0f}%|{bar:50}|  {n_fmt} / {total_fmt} MB {postfix}"
bar_format_Blocks = "{desc:32}{percentage:3.0f}%|{bar:50}|  {n_fmt} / {total_fmt} Blocks {postfix}"
bar_format_percent = "{desc:32}{percentage:3.0f}%|{bar:50}|  {n_fmt} / {total_fmt} % {postfix}"
bar_format_block_with_rate = "{desc:32}{percentage:3.0f}%|{bar:50}|  {n_fmt} / {total_fmt} - {rate_fmt}{postfix}"
...
space_bar_over_used.set_description("Space Used above Max Capacity:")
...
GC_bar = tqdm.tqdm(total=1, leave=True, unit=' Blocks', colour='yellow',miniters=0, bar_format=bar_format_block_with_rate)
